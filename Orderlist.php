     ...
     <form method="post" action="storedata.php?action=add&id=<?php echo $rs["order_id"]?>">
            ...
            <td id="idcell"><?php $rs["order_id"]?></td>
             ...
             <td  ><?php echo $rs["u_id"]?></td>
              ...
              <td  ><?php echo $rs["nameoncard"]?></td>
              <td><?php echo $rs["cardnumber"]?></td>
              <td  ><?php echo $rs["exp_date"]?></td>
              <td  ><?php echo $rs["Phone"]?></td>
              <input type="hidden" name="phone" value=" <?php echo $rs["Phone"]?>">
              <input type="hidden" name="user" value="<?php echo $rs["name"]?>">
              <input type="hidden" name="total" value="<?php echo $rs["total"]?>">

             <td  ><button type="submit" name="send" class="btn btn-dark  m-1">Send Message</button>
                </tr>
